"""Per-path Lipschitz ratios under adversarial perturbation.

Corrects the framing of the last two Method B tasks: don't merge the 16
reference-line paths into any single combined score (not the 496-dim
