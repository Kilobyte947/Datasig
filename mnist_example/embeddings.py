"""Feature-space embeddings for MNIST pixel vectors, generalizing toy_example/embeddings.py's polynomial_embedding
...
def elementwise_embedding(x_flat, degree):
    ...
    Matches toy_example/embeddings.py::polynomial_embedding's convention: this is 784 independent
