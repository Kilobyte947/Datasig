...
from mnist_example.models import StrongCNN, FlattenedInputWrapper, train_classifier
from mnist_example.estimators import euclidean_distance_fn, pairwise_lipschitz
from mnist_example.layer_decomposition import _effective_head_lipschitz_exact
from mnist_example.adversarial_strong_cnn import (
...
def test_compute_strong_cnn_bounds_mahalanobis_differs_from_euclidean():
    from mnist_example.distance import svd_ridge_precision, mahalanobis_distance
    model, train, test = _small_trained_strong_cnn()
    x_query, y_query = test.x_flat[:40], test.y[:40]
    x_train_for_norm = train.x_flat[:200]
