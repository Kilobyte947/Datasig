...
from mnist_example.models import SmallCNN, FlattenedInputWrapper, train_classifier, LogisticRegressionModel
...
TOLERANCE = 0.10  # matches mnist_example/tests/test_estimators.py's checkpoint tolerance
...
def test_margin_lipschitz_estimate_matches_closed_form_on_linear_model():
    ...
    mnist_example/tests/test_estimators.py's own closed-form check, applied to this module's
