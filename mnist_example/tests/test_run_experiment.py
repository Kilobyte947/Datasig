...
from mnist_example.run_experiment import class_separation_ratio, run_class_separation_check
...
def test_run_class_separation_check_runs_all_four_metrics_and_ranks_as_expected():
    ...
    README.md/notebook_distance_measures.ipynb's smoothing section) -- smoothed cross-terms + Euclidean beats raw-pixel
