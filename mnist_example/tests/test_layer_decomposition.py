...
from mnist_example.estimators import linear_layer_lipschitz
...
def test_fit_feature_normalizer_floor_is_relative_not_just_absolute():
    ...
    with torch.no_grad():
        from mnist_example.layer_decomposition import extractor_output_fn
...
def test_looseness_ratio_at_least_one_across_width_sweep():
    ...
    a full production sweep (see notebook_adversarial.ipynb's Section 1 for
    that)."""
