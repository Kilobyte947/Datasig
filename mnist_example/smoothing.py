...
`distance_measures.md`'s "Epsilon selection fails categorically for this embedding" section). The working
...
`notebook_distance_measures.ipynb`'s smoothing section for that sweep.
"""
...
under the fix -- see `distance_measures.md`'s smoothing sub-experiment for the corrected re-run, not this
